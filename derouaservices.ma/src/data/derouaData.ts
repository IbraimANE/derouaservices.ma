...
export const INITIAL_SERVICES: ServiceItem[] = [
  ...
  },
  {
    ...
    category: 'emergency',
    name: {
      ar: 'الهلال الأحمر المغربي - وحدة الإسعاف',
      fr: 'Croissant Rouge Marocain (Ambulance)',
      en: 'Moroccan Red Crescent (Ambulance)'
    },
    tradeOrRole: {
      ar: 'إسعاف ونقل المرضى',
      fr: 'Transport sanitaire & premiers soins',
      en: 'Medical transport & first aid'
    },
    phone: '0522530055',
    secondaryPhone: '141',
    whatsapp: '212661530055',
    address: {
      ar: 'قرب المركز الصحي الحضري، حي القصبة',
      fr: 'Près du Centre de Santé, Hay Kasbah',
      en: 'Near Health Center, Hay Kasbah'
    },
    neighborhood: {
      ar: 'حي القصبة',
      fr: 'Hay Kasbah',
    ...
    verified: true,
    description: {
      ar: 'نقل طبي للمستشفيات (برشيد، الدار البيضاء)، إسعاف أولي ونقل الحالات الحرجة.',
      fr: 'Transport médicalisé vers les hôpitaux de Berrechid et Casablanca.',
      en: 'Medical transport to Berrechid and Casablanca hospitals.'
    },
    workingHours: { ar: '24/24', fr: '24h/24', en: '24/7' }
  },
  ...
  },
  {
    ...
    category: 'municipal',
    name: {
      ar: 'المكتب الوطني للكهرباء والماء الصالح للشرب (قطاع الماء)',
      fr: 'ONEE - Branche Eau (Agence Deroua)',
      en: 'ONEE Water Agency Deroua'
    },
    tradeOrRole: {
      ar: 'تزويد الماء الصالح للشرب وخدمات الزبناء',
      fr: 'Distribution eau potable & facturation',
      en: 'Drinking Water & Billing'
    },
    phone: '0522530230',
    secondaryPhone: '0801000180',
    address: {
      ar: 'تجزئة الوفاق، شارع النخيل',
      fr: 'Lotissement Al Wifaq, Rue Ennakhil',
      en: 'Al Wifaq, Ennakhil St'
    },
    neighborhood: {
      ar: 'حي الوفاق',
      fr: 'Hay Al Wifaq',
    ...
    verified: true,
    description: {
      ar: 'ربط المنازل بعدادات الماء، أداء الفواتير، والتبليغ عن انقطاعات أو تسربات في الشبكة العمومية.',
      fr: 'Raccordements, paiement des factures et signalement des fuites du réseau.',
      en: 'Water meter connections, bill payments, and network leak reporting.'
    },
    workingHours: { ar: '08:30 - 15:30 (الإثنين - الجمعة)', fr: '08:30 - 15:30 (Lun - Ven)', en: '08:30 - 15:30 (Mon - Fri)' }
  },
  {
    id: 'mun-4',
    category: 'municipal',
    name: {
      ar: 'المكتب الوطني للكهرباء (قطاع الكهرباء - الدروة)',
      fr: 'ONEE - Branche Électricité (Dépannage & Agence)',
      en: 'ONEE Electricity Deroua'
    },
    tradeOrRole: {
      ar: 'خدمات وتوزيع الكهرباء',
      fr: 'Distribution électricité',
      en: 'Electricity Distribution'
    },
    phone: '0801000777',
    address: {
      ar: 'شارع الحسن الثاني، قرب المحطة الطرقية للسيارات',
      fr: 'Avenue Hassan II, près de la station de taxis',
      en: 'Hassan II Ave, near Taxi Station'
    },
    neighborhood: {
      ar: 'مركز الدروة',
      fr: 'Deroua Centre',
    ...
    isOpenNow: true,
    verified: true,
    workingHours: { ar: '08:30 - 15:30 (طوارئ الخط الأخضر 24/24)', fr: '08:30 - 15:30 (Urgence 24h/24)', en: '08:30 - 15:30 (Emergency 24/7)' }
  },
  ...
  // Commerce & Markets
  {
    ...
    category: 'commerce',
    name: {
      ar: 'السوق الأسبوعي للدروة (سوق الأحد)',
      fr: 'Souk Hebdomadaire de Deroua (Dimanche)',
      en: 'Deroua Weekly Souk (Sunday)'
    },
    tradeOrRole: {
      ar: 'سوق أسبوعي تقليدي للخضر والفواكه والماشية',
      fr: 'Grand marché hebdomadaire',
      en: 'Weekly Market'
    },
    phone: '0522530044',
    address: {
      ar: 'فضاء السوق الأسبوعي، المدخل الشمالي للدروة',
      fr: 'Espace du Souk, Entrée Nord de Deroua',
      en: 'Souk Area, North Entrance'
    },
    neighborhood: {
      ar: 'مركز الدروة',
      fr: 'Deroua Centre',
    ...
    verified: true,
    description: {
      ar: 'يقام كل يوم أحد: خضر وفواكه طازجة من مزارع الشاوية، لحوم، أسماك، حبوب، ملابس ومستلزمات منزلية بأسعار مناسبة.',
      fr: 'Chaque dimanche: produits frais du terroir de la Chaouia, viandes, légumes et artisanat.',
      en: 'Every Sunday: fresh farm produce from Chaouia plains, meats, and household items.'
    },
    workingHours: { ar: 'كل يوم أحد: 06:00 - 15:00', fr: 'Chaque dimanche: 06:00 - 15:00', en: 'Every Sunday: 06:00 - 15:00' }
  },
  {
    id: 'com-2',
    category: 'commerce',
    name: {
      ar: 'السوق البلدي النموذجي للسمك والخضر',
      fr: 'Marché Municipal Couvert de Deroua',
      en: 'Deroua Municipal Covered Market'
    },
    tradeOrRole: {
      ar: 'سوق بلدي يومي',
      fr: 'Marché de proximité quotidien',
      en: 'Daily Covered Market'
    },
    phone: '0522530046',
    address: {
      ar: 'حي القصبة، قرب الجامع الكبير',
      fr: 'Hay Kasbah, près de la Grande Mosquée',
      en: 'Hay Kasbah, near Grand Mosque'
    },
    neighborhood: {
      ar: 'حي القصبة',
      fr: 'Hay Kasbah',
    ...
    reviewsCount: 38,
    verified: true,
    workingHours: { ar: '07:00 - 20:00 يومياً', fr: '07:00 - 20:00 Tous les jours', en: '07:00 - 20:00 Daily' }
  }
];
